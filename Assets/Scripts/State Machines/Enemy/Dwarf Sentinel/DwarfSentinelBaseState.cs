...
{
    public abstract class DwarfSentinelBaseState : State
    {
        protected DwarfSentinelStateMachine stateMachine;

        public DwarfSentinelBaseState(DwarfSentinelStateMachine stateMachine)
        {
